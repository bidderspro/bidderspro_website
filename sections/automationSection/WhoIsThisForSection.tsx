...
const WhoIsThisForSection = () => {
  ...
  const GridItem = ({ area, icon, text }: GridItemProps) => {
    return (
      <motion.li 
      ...
      >
        <div className="relative h-full rounded-2xl border border-gray-700/50 p-2 md:rounded-3xl md:p-3">
          <GlowingEffect
            ...
            inactiveZone={0.01}
          />
          <div className="relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl border-0 border-gray-700/50 bg-gray-800/50 backdrop-blur-sm p-6 md:p-6 dark:shadow-[0px_0px_27px_0px_#2D2D2D]">
    ...
    <section className="py-20 sm:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="inline-block bg-[#E0E0FF]/10 backdrop-blur-sm border border-[#E0E0FF]/20 px-6 py-4 rounded-lg">
